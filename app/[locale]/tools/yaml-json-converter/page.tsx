...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? 'YAML JSON 변환기 무료 온라인 - tooltoolz' : 'YAML JSON Converter Free Online - tooltoolz', description: 'Convert simple YAML and JSON formats.' }
}
