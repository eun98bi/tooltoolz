...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? 'JSON CSV 변환기 무료 온라인 - tooltoolz' : 'JSON CSV Converter Free Online - tooltoolz', description: 'Convert JSON arrays to CSV and simple CSV to JSON.' }
}
