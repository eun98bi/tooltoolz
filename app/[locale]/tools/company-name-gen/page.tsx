...
const slug = 'company-name-gen' as const
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> { return { title: params.locale === 'kr' ? '회사명 생성기 무료 온라인 - tooltoolz' : 'Company Name Generator Free Online - tooltoolz', description: 'Generate brand and company names.', alternates: { canonical: `https://tooltoolz.com/${params.locale}/tools/company-name-gen`, languages: { ko: `https://tooltoolz.com/kr/tools/company-name-gen`, en: `https://tooltoolz.com/en/tools/company-name-gen` } } } }
