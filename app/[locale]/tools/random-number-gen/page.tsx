...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> { return { title: params.locale === 'kr' ? '랜덤 숫자 생성기 무료 온라인 - tooltoolz' : 'Random Number Generator Free Online - tooltoolz', description: 'Generate random numbers from a range.' } }
