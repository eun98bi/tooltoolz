...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? '유튜브 수익 계산기 무료 온라인 - tooltoolz' : 'YouTube Earnings Calculator Free Online - tooltoolz', description: 'Estimate creator revenue from views, CPM, and share.' }
}
