...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? '자막 타임코드 변환기 무료 온라인 - tooltoolz' : 'Subtitle Timestamp Converter Free Online - tooltoolz', description: 'Convert SRT and VTT timestamps or shift subtitle timing.' }
}
