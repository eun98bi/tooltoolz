...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? '파일명 정리기 무료 온라인 - tooltoolz' : 'Filename Organizer Free Online - tooltoolz', description: 'Preview bulk filename numbering and cleanup rules.' }
}
