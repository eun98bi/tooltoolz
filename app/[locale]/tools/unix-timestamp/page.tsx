...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? 'Unix 타임스탬프 변환기 무료 온라인 - tooltoolz' : 'Unix Timestamp Converter Free Online - tooltoolz', description: 'Convert Unix timestamps and dates.' }
}
