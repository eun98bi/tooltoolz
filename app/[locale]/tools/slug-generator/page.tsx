...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://tooltoolz.com/${params.locale}/tools/slug-generator`,
      languages: {
        ko: `https://tooltoolz.com/kr/tools/slug-generator`,
        en: `https://tooltoolz.com/en/tools/slug-generator`,
      },
    },
  }
}
