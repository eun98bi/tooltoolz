...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  return { title: params.locale === 'kr' ? '이미지 Base64 변환기 무료 온라인 - tooltoolz' : 'Image to Base64 Converter Free Online - tooltoolz', description: 'Convert image files to Base64 data URIs locally.' }
}
